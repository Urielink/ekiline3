...
if( true === get_theme_mod( 'ekiline_bootstrapeditor', true ) ) {
	...
	// Arreglo para incorporar el script al head || add script to head
		...
		echo '<script>'	."\n".
				...
				// 'var showGrid ="' . __('Show gridooooo', 'ekiline') . '";'	."\n".								
			 '</script>'."\n";
		}
...
/** traducciones de ekiline para el tinymce con gutenberg, sin el metodo oficial **/
// ejercicio con Localize.
// https://codex.wordpress.org/Plugin_API/Action_Reference/admin_enqueue_scripts
// https://codex.wordpress.org/I18n_for_WordPress_Developers
function my_enqueue() {
	
wp_enqueue_script( 'testlangjs', get_template_directory_uri() . '/js/ekilineEditor.js' );

wp_localize_script( 'testlangjs', 'objectL10n', array(
// function ekiline_tinymceLangs() {
// 	
    // $strings = array(
